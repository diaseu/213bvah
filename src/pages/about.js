      ...
      <div className={content}>
        <div className={about}>
          ...
          <p>
            ...
            pet's wellbeing by combing compassion and expert professional care.
            Come on in to join our family!
          </p>
        </div>
        <div className={about}>
          {/* About Staff */}
          ...
          <div className={row}>
            <img src="https://i.imgur.com/dvobYFp.jpeg" alt="Dr Seong Kim DVM" />
            <div>
